    ...
    <div>
      ...
      <div className="container">
        ...
        <section className={styles.whatsappSection}>
          <a href="https://wa.me/919999999999?text=Hi! I want to know more about Lens For Eyesight." className={styles.whatsappBtn} target="_blank" rel="noreferrer" id="whatsapp-contact">
