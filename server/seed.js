...
const sampleProducts = [
  ...
  {
    name: 'Kids Reading Glasses - Galaxy Blue',
    brand: 'Fastrack', category: 'Reading Glasses',
    gender: 'Kids', frameShape: 'Square', frameMaterial: 'TR90', frameWidth: 'Narrow',
    price: 699, comparePrice: 1199, discount: 42,
    slug: 'kids-reading-galaxy-blue',
    variants: [
      { color: 'Galaxy Blue', colorHex: '#1034A6', images: ['/img/products/kids_purple_round_1776925226059.png'], stock: 50, sku: 'FT-KIDS-BLU' }
    ],
    features: ['Anti-Glare Coating', 'Blue Light Blocking', 'Flexible frame', 'Child-Safe'],
    description: 'Perfect reading glasses for kids who spend time with books and screens. Protect those precious young eyes!',
    isNewArrival: true,
    tags: ['kids', 'reading', 'blue cut', 'school', 'computer', 'children'],
  },
];
...
async function seed() {
  try {
    ...
    console.log(`✅ Admin user: admin@lensforeyesight.com / Admin@123`);
    ...
    console.log('Brands seeded: Ray-Ban, Vogue, Fastrack, Zeiss, Vincent Chase, John Jacobs, Lenskart');
    console.log('='.repeat(50));
    process.exit(0);
  } catch (err) {
